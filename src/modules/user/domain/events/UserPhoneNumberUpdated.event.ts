...
export class UserPhoneNumberUpdatedEvent extends BaseDomainEvent <UserPhoneNumberPayload> {
    public static readonly EVENT_NAME = 'UserPhoneNumberUpdated';

    constructor (payload: UserPhoneNumberPayload, metadata?: {correlationId?: string}) {
